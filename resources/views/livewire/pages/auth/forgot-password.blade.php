...
<div class="min-h-[calc(100%-151px)] bg-white w-full py-10 rounded-xl">
        <div class="w-[350px] max-w-full mx-auto">
            <div
                class="mb-10 mx-auto text-center">
                <p class="text-4xl text-[#000]/80 font-bold">Recuperar senha</p>
                <p class="text-[#000]/60 text-xs font-medium">Esqueceu sua senha? Receba um link por e-mail e crie uma nova</p>
            </div>
            ...
            <form class="mx-auto grid gap-4 mb-0" method="POST" action="{{ route('forget.password.post') }}">
                ...
                <div>
                    ...
                    <p class="col-span-12 mx-auto text-gray-500 text-center w-[350px] max-w-full mt-4" style="border: 1px dashed #0000002e; border-radius: 7px; padding: 14px 0 10px; line-height: 15px; font-size: 17px;">
                        Lembrou sua senha?<br>
                        <a href="{{ route('login') }}" class="font-semibold leading-6 text-primary">Clique aqui para acessar!</a>
                    </p>
                </div>
            </form>
        </div>
