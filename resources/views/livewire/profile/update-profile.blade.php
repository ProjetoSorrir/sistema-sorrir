<div>
    ...
    <div class="pb-6">
        <div class="box p-6">
            <p class="text-[25px] text-primary font-semibold">Atualize seu perfil</p>
            ...
            @endif
            <form wire:submit="updateProfileInformation" class="col-span-12 grid grid-cols-12 gap-4 text-left">

                <div class="input-container col-span-12">
                    <label for="name">Seu Nome:</label>
                    <input wire:model='name'type="text" placeholder="Seu nome" class="bg-white">
                    @error('name')
                ...
                <div class="input-container col-span-12 ">
                    ...
                    <input wire:model='email' type="text" placeholder="email@email.com" class="bg-white">
                    @error('email')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div wire:ignore class="input-container col-span-12 ">
                    ...
                    <input id="phone" name="phone" type="text" placeholder="Digite seu telefone" maxlength="15"
                        ...
                        oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="w-full bg-white">
                </div>
                <div class="input-container col-span-12">
                    @error('phone')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                ...
                <input type="hidden" id="ddi_hidden" name="ddi" wire:model="ddi" readonly class="bg-white">



                <div class="col-span-12">

                    <button class="primary-button w-full text-white uppercase font-bold">Atualizar informações</button>
        ...
        <div class="box p-6 mt-4">
            <p class="text-[25px] text-primary font-semibold">Atualize sua Senha</p>
            <form wire:submit.prevent="updatePassword" class="grid grid-cols-12 gap-4">
                <div>
                ...
                <div id="show_hide_password" class="col-span-12">
                    ...
                    <div
                        class="flex items-center rounded border px-1 border-[#b4b4b4] w-full text-black font-medium bg-white">
                        <input type="password" wire:model="current_password" autocomplete="password"
                            placeholder="Sua senha atual" class="border-none w-full bg-white" id="current_password">
                        <div id="current_password-eye" class="mr-2 cursor-pointer bg-white"
                ...
                <div id="show_hide_password" class="col-span-12">
                    <label for="password" class="text-sm font-bold tracking-wide">Confirme Sua Nova
                        Senha:</label>
                    <div
                        class="flex items-center rounded border px-1 border-[#b4b4b4] w-full text-black font-medium bg-white">
                ...
                <div class="col-span-12 pb-10">
                    <button type="submit" class="primary-button w-full text-white">Atualizar Senha</button>
                    <x-action-message class="me-3" on="password-updated text-white">
