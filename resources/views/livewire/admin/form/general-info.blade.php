    ...
    <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" x-data="dragDrop()">
                    <div class="drop-container border-2 border-dashed border-secondary rounded-md flex flex-col items-center p-6 text-primary font-bold"
                        ...
                        <h4 class="text-center">Clique para enviar ou arraste e solte<br />SVG, PNG, JPG ou GIF (Max.
                            800px
                            x 400px)</h4>
                    </div>
                </div>
        ...
        <div class="col-span-4">
            <div class="input-container">
                ...
                <select wire:model="draw_held" type="text" id="draw_held" name="draw_held" class="text-dark-grey">
        ...
        <div class="col-span-2">
            <div class="input-container">
                ...
                <input wire:model="name" type="text" id="name" placeholder="Local do Sorteio">
                @error('name')
                    @if (empty($name))
                        <span class="text-red-500">{{ $message }}</span>
                    @endif
        ...
        <div class="page-instructions col-span-12">Defina a data e hora na qual deseja que sua rifa vá ao ar, caso
            não
            preencha
